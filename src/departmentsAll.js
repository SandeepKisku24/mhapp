            ...
            <Card shadow="sm" style={{width:"150px", height:"", margin:"1px", cursor:"pointer"}} padding="lg" radius="md"  withBorder onMouseEnter={()=>{
             ...
             <Card shadow="sm" style={{width:"150px", height:"", margin:"1px", cursor:"pointer"}} padding="lg" radius="md"  withBorder onMouseEnter={()=>{
                    ...
                    <Stack justify="space-between"   h={200} align="stretch" gap={10}>
                        ...
                        <Link to="/department/orthopedic" style={{}}>
                            <Button color="blue" fullWidth mt="md" radius="md" >
                                Know More
                            </Button>
                        </Link>
                  ...
                  <Card shadow="sm" style={{width:"150px", height:"", margin:"1px", cursor:"pointer"}} padding="lg" radius="md"  withBorder onMouseEnter={()=>{
                    ...
                    <Stack justify="space-between"  h={200}align="stretch" gap={10}>
                        ...
                        <Link to="/department/famililymedicine" style={{}}>
                            <Button color="blue" fullWidth mt="md" radius="md" >
                                Know More
                            </Button>
                        </Link>
                  ...
                  <Card shadow="sm" style={{width:"150px", height:"", margin:"1px", cursor:"pointer"}} padding="lg" radius="md"  withBorder onMouseEnter={()=>{
                    ...
                    <Stack justify="space-between"  h={200} align="stretch" gap={10}>
                        ...
                        <Link to="/department/generalmedicine" style={{}}>
                            <Button color="blue" fullWidth mt="md" radius="md" >
                                Know More
                            </Button>
                        </Link>
